...
object GenTPCDSTableScripts {
  ...
  def main(args: Array[String]): Unit = {
    genTPCDSCSV2ParquetSQL()
    // genTPCDSParquetTables()
    // genTPCDSMergeTreeTables()
  }

  def genTPCDSMergeTreeTables(): Unit = {
    val dbName = "chdb"
  ...
  def genTPCDSParquetTables(): Unit = {
    val dbName = "tpchdb"
  ...
  def genTPCDSCSV2ParquetSQL(): ArrayBuffer[String] = {
    val dbName = "tpcds_gendb"
    val parquetDbName = "tpcdsdb"
    val csvPathRoot = "/data2/tpcds-data-gen/tpcds10-data/"
    val parquetPathRoot = "/data1/test_output/tpcds-data-sf10/"

    val tablePrefix = "tpcdsdb."
    val tableSuffix = ""
